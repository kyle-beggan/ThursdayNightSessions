    ...
    return (
        <>
            ...
            >
                <button
                    onClick={onClick}
                    className="w-full h-full text-left p-3 bg-primary/20 border border-primary/20 hover:bg-primary/30 hover:border-primary/50 hover:shadow-[0_0_15px_rgba(139,92,246,0.5)] rounded-lg transition-all duration-200 flex flex-col group"
                >
