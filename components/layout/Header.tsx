            ...
            <header className="w-full bg-surface/50 backdrop-blur-lg border-b border-border sticky top-0 z-50">
                <div className="w-full flex justify-center py-4 relative">
                    ...
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 z-10">
                        <button
                            onClick={toggleTheme}
                            className="flex items-center gap-2 p-2 rounded-lg hover:bg-surface-hover text-text-secondary hover:text-text-primary transition-colors"
                        ...
                        >
                            {!mounted ? (
                                ...
                                <>
                                    ...
                                    <span className="text-[10px] md:text-xs font-medium inline">Light Mode</span>
                                </>
                            ) : (
                                <>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                                    ...
                                    <span className="text-[10px] md:text-xs font-medium inline">Dark Mode</span>
                                </>
                            )}
                        </button>
                    </div>
