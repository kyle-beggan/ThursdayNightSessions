                        ...
                        {session?.user?.name && (
                            <div className="absolute right-4">
                                <Menu as="div" className="relative inline-block text-left">
                                    <Menu.Button className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-surface-secondary transition-colors text-text-primary font-medium focus:outline-none focus:ring-2 focus:ring-primary/50">
